...
const char* ourObjectPath = "./mesh1.obj";
// translate it so it's at the center of the scene
// it's a bit too big for our scene, so scale it down
glm::mat4 objectXform1 = glm::scale(glm::translate(glm::mat4(1.0f), glm::vec3(0.5f, 0.0f, 0.0f)), glm::vec3(0.03f, 0.03f, 0.03f));
glm::mat4 objectXform2 = glm::rotate(objectXform1, glm::radians(200.0f), glm::vec3(1.0f, 0.0f, 0.0f));
glm::mat4 objectXform = glm::translate(objectXform2, glm::vec3(0.0f, -7.0f, 0.0f));
...
void mouse_callback(GLFWwindow* window, double xpos, double ypos)
{
	...
	float xoffset = (float)(xpos - lastX)/ SCR_WIDTH; /// 수정 : SCR_WIDTH;
	float yoffset = (float)(lastY - ypos)/ SCR_HEIGHT; /// SCR_HEIGHT; // reversed since y-coordinates go from bottom to top
